...
public class ShowAllNotesActivity extends AppCompatActivity implements NoteItemClickListener{
    ...
    public void setMyAdapter(List<Note> nts){
        noteAdapter = new NoteAdapter(ShowAllNotesActivity.this, nts, ShowAllNotesActivity.this);
        noteRV.setAdapter(noteAdapter);
        noteRV.setLayoutManager(new LinearLayoutManager(ShowAllNotesActivity.this, LinearLayoutManager.VERTICAL, false));
    }
