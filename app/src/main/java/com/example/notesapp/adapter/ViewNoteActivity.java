...
public class ViewNoteActivity extends AppCompatActivity implements NoteItemClickListener{
    ...
    public void setMyAdapter(List<Note> nts){
        noteAdapter = new NoteAdapter(ViewNoteActivity.this, nts, ViewNoteActivity.this);
        noteRV.setAdapter(noteAdapter);
        noteRV.setLayoutManager(new LinearLayoutManager(ViewNoteActivity.this, LinearLayoutManager.VERTICAL, false));
    }
